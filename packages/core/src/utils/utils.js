 ...
 */
export const toHHMMSS = function (
  v,
  includeHour = false,
  includeSeconds = true
) {
 ...
 * 
 * @param {Array<T>} array
 * @returns Array<T> array of only the unique values
 */
 ...
 * 
 * @param {Array<T>} array
 * @returns Array<T> shuffled array, but array is changed in place
 */
 ...
 * @param {string} v1 
 * @param {string} v2 
 * @param {{ lexicographical?: boolean, zeroExtend?: boolean }?} [options] 
 * @returns number
 */
